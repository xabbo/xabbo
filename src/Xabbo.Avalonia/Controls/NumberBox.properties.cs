...
public partial class NumberBox
{
    ...
    public static readonly StyledProperty<double> MinimumProperty =
        RangeBase.MinimumProperty.AddOwner<NumberBox>(
            new StyledPropertyMetadata<double>(
                ...
                coerce: (ao, d1) =>
                {
                    if (ao is NumberBox { Maximum: double max } nb)
                    {
                        if (d1 > max)
                            d1 = max;
    ...
    public static readonly StyledProperty<double> MaximumProperty =
        RangeBase.MaximumProperty.AddOwner<NumberBox>(
            new StyledPropertyMetadata<double>(
                ...
                coerce: (ao, d1) =>
                {
                    if (ao is NumberBox { Minimum: double min } nb)
                    {
                        if (d1 < min)
                            d1 = min;
    ...
    /// <summary>
    /// Defines the <see cref="MyNumberBoxValidationMode"/> property
    /// </summary>
    ...
    /// <summary>
    /// A function for customizing the format of the MyNumberBox Value Text.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// Gets or sets a value that indicates how the reading order is determined for the MyNumberBox.
    /// NOTE This property is not implemented
    /// </summary>
    [NotImplemented]
    ...
    /// <summary>
    /// Gets or sets the numeric value of a MyNumberBox.
    /// </summary>
    public double Value
    {
    ...
    /// <summary>
    /// Gets or sets the TextAlignment of the text in the MyNumberBox
    /// </summary>
